...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  // Secure CSS generation with proper sanitization
  const sanitizeCSS = (input: string): string => {
    // Remove any potentially dangerous characters and ensure CSS safety
    return input.replace(/[<>'"&]/g, '').replace(/javascript:|data:/gi, '')
  }

  const sanitizeId = (input: string): string => {
    // Ensure ID only contains safe characters
